...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '陈米学系', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '中药分析学研究生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'notion,blog,博客,陈米学系,李希望,HopeLee,h0pe1ee', // 网站关键词 英文逗号隔开
